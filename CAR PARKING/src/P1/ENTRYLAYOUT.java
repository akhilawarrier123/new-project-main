...
public class ENTRYLAYOUT {
	...
	static int time_from_exit;
	static int value_to_exit;
	...
	
	{
	   ...
	   //EXITLAYOUT EN=new EXITLAYOUT();
	 //  EN.
	   
	  // System.out.println(Arrays.asList(M)); // method 1
	  // System.out.println(Collections.singletonList(M)); // method 2
